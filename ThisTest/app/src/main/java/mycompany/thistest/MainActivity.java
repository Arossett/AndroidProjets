...
public class MainActivity extends FragmentActivity implements LocListener {
        ...
        btnShowOnMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if(servicesConnected() && nearPlaces.status.equals("OK")) {
                    ...
                    i.putExtra("user_latitude", Double.toString(/*locationTest*/gps.getLatitude()));
                    i.putExtra("user_longitude", Double.toString(/*locationTest*/gps.getLongitude()));
    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            Log.v("nawak", "gps :"+  gps.getLatitude() + " , " +  gps.getLongitude());
